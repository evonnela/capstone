...
const Quiz = ({ setWalletPoints, userId }) => {
    ...
    const userKey = encodeEmail(userId); // ✅ consistent key
    const quizDataRef = ref(db, `users/${userKey}/quizData`);
    ...
    const quizData = [
        {
            ...
            questions: [
                {
                    id: 1,
                    text: 'What caused Jonas to feel frightened and stay indoors?',
                    options: [
        ...
        },
        {
            ...
            questions: [
                {
                    id: 2,
                    text: "Why was Jonas's father worried about the newchild?",
                    options: [
                        'A) The newchild was frequently breaking rules.',
        ...
        },
        {
            ...
            questions: [
                {
                    id: 3,
                    text: 'Why does Jonas feel apprehensive in this scene?',
                    options: [
                        "A) He is worried about his father's job in the night crew.",
        ...
        },
        {
            ...
            questions: [
                {
                    id: 4,
                    text: 'What does Jonas’s father reveal about breaking a rule? ',
                    options: [
                        'A) He broke a rule by looking at the Naming list early to see the newchild’s name.',
        ...
        },
        {
            ...
            questions: [
                {
                    id: 5,
                    text: "What does Jonas's mother warn him about regarding the Ceremony of Twelve?",
                    options: [
                        'A) Jonas will be separated from his family after the Ceremony.',
        ...
        },
        {
            ...
            questions: [
                {
                    id: 6,
                    text: 'What does Jonas’s mother say about the changes after the Ceremony of Twelve?',
                    options: [
                        'A) He will no longer have to do any schoolwork or assignments.',
        ...
        },
        {
            ...
            questions: [
                {
                    id: 7,
                    text: 'What makes Jonas feel self-conscious when he looks at the newchild?',
                    options: [
                        'A) The newchild’s eyes are pale like his own.',
        ...
        },
        {
            ...
            questions: [
                {
                    id: 8,
                    text: 'What does Jonas think would be an appropriate Assignment for Lily?',
                    options: ['A) Birthmother', 'B) Speaker', 'C) Nurturer'],
                    correctAnswer: 'B',
                },
            ],
        },
        {
            ...
            questions: [
                {
                    id: 9,
                    text: 'What unusual thing happens when Jonas is playing catch with the apple?',
                    options: [
                        'A) The apple changes shape in mid-air.',
                        'B) The apple turns into a different color',
                        'C) The apple disappears when Jonas catches it',
                    ],
                    correctAnswer: 'A',
                },
            ],
    ...
    const currentQuiz = quizData.find(
        (quiz) => quiz.pageNumber === currentPage
    );
